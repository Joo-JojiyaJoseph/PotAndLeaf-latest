...
import {
  ...
  ShoppingCartIcon, PlusCircleIcon, ChartBarIcon, QrCodeIcon, TagIcon,
...
const QUICK = [
  ...
  { label: 'Companies', desc: 'Manage your companies', to: '/companies', icon: TagIcon },
  { label: 'Suppliers', desc: 'Manage your suppliers', to: '/suppliers', icon: TagIcon },
];
