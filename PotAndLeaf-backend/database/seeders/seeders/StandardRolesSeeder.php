...
class StandardRolesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roles = [
            'Manager'      => ['suppliers.', 'products.', 'purchases.', 'inventory.', 'damage.', 'purchase_returns.', 'sales_returns.', 'stock_verifications.', 'bulk_splits.', 'sales.', 'customers.', 'payments.', 'receipts.', 'commission.', 'transfers.', 'locations.', 'production.', 'rental.', 'reports.', 'activity.', 'backup.', 'po.', 'advance.', 'categories.', 'brands.', 'units.', 'users.view', 'roles.view'],
            'Cashier'      => ['products.view', 'inventory.view', 'sales.view', 'sales.create', 'sales.confirm', 'sales_returns.view', 'sales_returns.create', 'sales_returns.confirm', 'customers.view', 'customers.create', 'receipts.view', 'receipts.create'],
